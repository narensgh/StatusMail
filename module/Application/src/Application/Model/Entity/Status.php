...
class Status
{
    ...
    /**
     * @var \Application\Model\Entity\Task
     *
     * @ORM\ManyToOne(targetEntity="Application\Model\Entity\Task")
     * @ORM\JoinColumns({
     ...
     * Set task
     *
     * @param \Application\Model\Entity\Task $task
     * @return Status
     */
    public function setTask(\Application\Model\Entity\Task $task = null)
    {
        $this->task = $task;
     ...
     * Get task
     *
     * @return \Application\Model\Entity\Task 
     */
